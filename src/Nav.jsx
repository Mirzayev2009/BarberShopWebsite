...
const Nav = () => {
  ...
  return (
    <div className='w-full px-4 md:px-16 flex flex-col md:flex-row justify-between items-center py-4 bg-amber-500 text-white shadow-lg sticky top-0 left-0 z-50'>
      {/* Logo and Brand */}
      <div
